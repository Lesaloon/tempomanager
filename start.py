...
def modify_data(trame):
	...
	# the clamp is monitoring a 240v 50hz AC solar panel so we increased the output voltage by 3.3v to be able to measure it
	...
	current1 = (solar1.voltage-(3.3/2) )* (5/1)
	current2 = (solar2.voltage-(3.3/2) )* (5/1)
